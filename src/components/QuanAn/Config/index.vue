        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h6 class="mt-2">Cấu Hình Giờ Mở Cửa/Đóng Cửa</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="">Giờ Mở Cửa</label>
                            <input type="time" class="form-control" placeholder="Giờ Mở Cửa" v-model="quan_an.gio_mo_cua">
                        </div>
                        <div class="col-lg-6">
                            <label for="">Giờ Đóng Cửa</label>
                            <input type="time" class="form-control" placeholder="Giờ Đóng Cửa" v-model="quan_an.gio_dong_cua">
                        </div>

                        <div class="col-lg-12 mt-3">
                            <label for="">Địa Chỉ</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Nhập địa chỉ quán ăn" v-model="quan_an.dia_chi">
                                <span class="input-group-text bg-danger text-white" id="basic-addon2" v-on:click="search_dia_chi()">Tìm Kiếm</span>
                            </div>
                        </div>
